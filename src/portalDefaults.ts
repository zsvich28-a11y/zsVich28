...
export const DEFAULT_POLLS: Poll[] = [
  {
    ...
    options: ['ЗА (Одобрувам)', 'ПРОТИВ (Не одобрувам)', 'ВОЗДРЖАН'],
    ...
    votes: [
      ...
      { apartmentNo: '28', optionIndex: 2, timestamp: '2026-08-23 08:00' },
    ]
  },
  {
    id: 'poll-2',
    ...
    options: ['ЗА промена', 'ПРОТИВ (Да остане 15:00-17:00)', 'ВОЗДРЖАН'],
    ...
    votes: [
      ...
      { apartmentNo: '42', optionIndex: 2, timestamp: '2026-08-13 10:00' },
